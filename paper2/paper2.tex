...
consider a uniform prior over appropriate bounds which gives emphasis to the recorded data.
The procedure for computing the noisy likelihood
...
to describe the location of multiple events whose maximum corresponding to
...
optimize $L$. It uses the derivatives of $L$, derived in Appendix
...
The hypoDD algorithm also struggles to locate all events as the number
...
at Geoscience Australia as well; as well as comments and advice received from 
Felix Waldhauser on the this and earlier research on the application of 

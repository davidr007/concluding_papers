...
data. Synthetic examples (2D and 3D) and real earthquakes on
...
to the retrospective seismological observation technique of 
...
before applying CWI$^*$} \label{tab:-conditions4unsuitablewaveform}
...
\end{tabular}
\end{table}
$^*$ Originally published as Table
5 in \citet{dr_Robinson11a}
